...
struct qt_meta_stringdata_CLASSUpLoadENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSUpLoadENDCLASS = QtMocHelpers::stringData(
    "UpLoad",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSUpLoadENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject UpLoad::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSUpLoadENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSUpLoadENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSUpLoadENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *UpLoad::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSUpLoadENDCLASS.stringdata0))
