...
""));
        ...
        layoutWidget1 = new QWidget(CommentDetails);
        layoutWidget1->setObjectName("layoutWidget1");
        layoutWidget1->setGeometry(QRect(30, 40, 421, 574));
        verticalLayout = new QVBoxLayout(layoutWidget1);
        verticalLayout->setObjectName("verticalLayout");
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        comment1 = new QLabel(layoutWidget1);
        ...
        comment2 = new QLabel(layoutWidget1);
        ...
        comment3 = new QLabel(layoutWidget1);
        ...
        comment4 = new QLabel(layoutWidget1);
        ...
        comment5 = new QLabel(layoutWidget1);
        ...
        comment6 = new QLabel(layoutWidget1);
        ...
        comment7 = new QLabel(layoutWidget1);
        ...
        comment8 = new QLabel(layoutWidget1);
        ...
        comment9 = new QLabel(layoutWidget1);
        ...
        comment10 = new QLabel(layoutWidget1);
    ...
    {
        CommentDetails->setWindowTitle(QCoreApplication::translate("CommentDetails", "PKU eater", nullptr));
