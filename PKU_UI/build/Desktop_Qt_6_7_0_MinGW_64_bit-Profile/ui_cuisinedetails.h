...
""));
        ...
        cuisineName->setGeometry(QRect(20, 60, 151, 31));
        QFont font2;
...
""));
        ...
        changeSelectedComments->setFont(font2);
        ...
        selectedComments->setFont(font2);
    ...
    {
        CuisineDetails->setWindowTitle(QCoreApplication::translate("CuisineDetails", "Dialog", nullptr));
